...
const projectRecords = [
  { id: 'crux', title: 'CRUX', category: 'Computer Vision / Web App', desc: 'Turn a climbing-wall photo into new challenges.', date: '2026-09', image: 'overhang-loop-v3.mp4', thumbnailPoster: 'overhang-poster.jpg', thumbnailFit: 'cover', previewLabel: 'Overhang photo, detected wall faces, hold outlines, and a generated climb', projectPage: '/crux/' },
  ...
  { id: 'floating-cubes', title: 'Reactive Cubes', category: 'Web3D', desc: 'Performant InstancedMesh effects using React Three Fiber.', date: '2023-12', github: 'https://github.com/Jetpackjules/floating-cubes' }
];

export const projectsData = projectRecords
  .slice()
  .sort((a, b) => b.date.localeCompare(a.date))
  .map((project, index) => ({ ...project, delay: (index + 1) * 0.1 }));
