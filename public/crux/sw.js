...
const APP='crux-app-v24',ASSETS='crux-model-assets-v1';
...
CORE.push('demo-hold-boxes.mjs','demo-hold-boxes.json');
...
self.addEventListener('fetch',event=>{
 const req=event.request,url=new URL(req.url);if(req.method!=='GET'||url.origin!==self.location.origin||url.search&&url.search!=='?v=24')return;
